...
public class HorseHandlerTest {
  ...
  void testFindAllHorses() {
    ...
    HORSE_DATA.put("1", new Horse("1", "horse breed 1", BloodType.COLD));
    HORSE_DATA.put("2", new Horse("2", "horse breed 2", BloodType.WARM));
    HORSE_DATA.put("3", new Horse("3", "horse breed 3", BloodType.HOT));
    HORSE_DATA.put("4", new Horse("4", "horse breed 4", BloodType.WARM));
